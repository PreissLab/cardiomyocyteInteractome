...
```{r loading_libraries_external_data_functions, echo = FALSE, cache = TRUE, eval = FALSE, tidy=TRUE, tidy.opts=(width.cutoff=60)}
library("biomaRt")
library("gdata")
library("GO.db")
library("KEGGREST")
...
```{r loading_data_tables, echo = TRUE, eval = FALSE, tidy=TRUE, tidy.opts=(width.cutoff=60)}
...
```{r fetching_keggIDs_code, echo = TRUE, cache = TRUE, eval = FALSE, tidy=TRUE, tidy.opts=(width.cutoff=60)}
...
```{r wcl_mapping_and_analysis, echo = TRUE, cache = TRUE, eval = FALSE, tidy=TRUE, tidy.opts=(width.cutoff=60)}
...
```{r interactome_mapping_and_analysis, echo = TRUE, cache = TRUE, eval = FALSE, tidy=TRUE, tidy.opts=(width.cutoff=60)}
...
```{r interactome_levelB_enrichment, echo=TRUE, cache=TRUE, eval=FALSE, tidy=TRUE, tidy.opts=(width.cutoff=60)}
